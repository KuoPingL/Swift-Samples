//
//  DianChanImprovedDummyCollectionViewController.swift
...
protocol DianChanImprovedDummyCollectionViewControllerDelegate: NSObjectProtocol {
...
protocol DianChanImprovedDummyCollectionViewControllerProtocol: NSObjectProtocol {
...
class DianChanImprovedDummyCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    enum Types {
        case advertice
        case photo
    }
    ...
    weak var delegate: DianChanImprovedDummyCollectionViewControllerDelegate? {
        didSet {
            if delegate != nil {
    ...
    override func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        if targetContentOffset.pointee.y <= 0 {
            ...
            let targetPointer = withUnsafeMutablePointer(to: &targetPoint) { $0 }
            
            super.scrollViewWillEndDragging(scrollView, withVelocity: velocity, targetContentOffset: targetPointer)
...
extension DianChanImprovedDummyCollectionViewController: DianChanImprovedDummyCollectionViewControllerProtocol {
